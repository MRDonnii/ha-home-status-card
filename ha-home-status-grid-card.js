...
class HaHomeStatusCard extends HTMLElement {
  ...
  render() {
    ...
    if (!this._rendered) {
      ...
      @media(min-width:1101px) and (max-height:950px){.item{height:72px;padding:7px 10px}.value{font-size:16px;line-height:18px}.meter{margin:3px 0}.detail,.label{font-size:10px;line-height:12px}.bg-icon{width:51px;height:51px;--mdc-icon-size:51px}}
